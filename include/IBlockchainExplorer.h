...
public:
  ...
  virtual void poolUpdated(const std::vector<transaction_details_t>& newTransactions, const std::vector<std::pair<hash_t, transaction_remove_reason_t>>& removedTransactions) {}
...
public:
  ...
  virtual bool getTransactions(const std::vector<hash_t>& transactionHashes, std::vector<transaction_details_t>& transactions) = 0;
  virtual bool getTransactionsByPaymentId(const hash_t& paymentId, std::vector<transaction_details_t>& transactions) = 0;
  ...
  virtual bool getPoolState(const std::vector<hash_t>& knownPoolTransactionHashes, hash_t knownBlockchainTop, bool& isBlockchainActual, std::vector<transaction_details_t>& newTransactions, std::vector<hash_t>& removedTransactions) = 0;
