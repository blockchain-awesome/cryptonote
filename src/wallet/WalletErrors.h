...
public:
  ...
  virtual std::string message(int ev) const override {
    ...
    case TRANSACTION_SIZE_TOO_BIG: return "transaction_t size is too big";
    ...
    case TX_TRANSFER_IMPOSSIBLE:   return "transaction_t transfer impossible";
    case WRONG_VERSION:            return "Wrong version";
    case FEE_TOO_SMALL:            return "transaction_t fee is too small";
