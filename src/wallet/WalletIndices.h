...
typedef boost::multi_index_container <
  ...
  boost::multi_index::indexed_by <
    ...
    BOOST_MULTI_INDEX_MEMBER(WalletRecord, public_key_t, spendPublicKey)>,
...
typedef boost::multi_index_container <
  ...
  boost::multi_index::indexed_by <
    ...
    boost::multi_index::hashed_non_unique < boost::multi_index::tag <TransactionHashIndex>,
      BOOST_MULTI_INDEX_MEMBER(UnlockTransactionJob, hash_t, transactionHash)
    >
  >
...
typedef std::map<size_t, transaction_t> UncommitedTransactions;
...
typedef boost::multi_index_container<
  ...
  boost::multi_index::indexed_by <
    ...
    boost::multi_index::hashed_unique<
      ...
      boost::multi_index::identity<hash_t>
    >
  >
