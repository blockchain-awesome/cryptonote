...
namespace serialize
{
  namespace primitive
  {
    ...
    inline std::istream &operator>>(std::istream &i, size_t &v) { return varint(i, v); }
    inline std::istream &operator>>(std::istream &i, bool &v) { return bytes(i, v); }
    ...
    inline std::ostream &operator<<(std::ostream &o, const size_t &v) { return varint(o, v); }
    inline std::ostream &operator<<(std::ostream &o, const bool &v) { return bytes(o, v); }
  }
}
