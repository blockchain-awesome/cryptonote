...
public:
  ...
  virtual bool getTransactions(const std::vector<crypto::hash_t>& transactionHashes, std::vector<TransactionDetails>& transactions) override;
  virtual bool getTransactionsByPaymentId(const crypto::hash_t& paymentId, std::vector<TransactionDetails>& transactions) override;
  ...
  virtual bool getPoolState(const std::vector<crypto::hash_t>& knownPoolTransactionHashes, crypto::hash_t knownBlockchainTop, bool& isBlockchainActual, std::vector<TransactionDetails>& newTransactions, std::vector<crypto::hash_t>& removedTransactions) override;
