...
public:
  ...
  bool fillTransactionDetails(const transaction_t &tx, transaction_explorer_details_t& txRpcInfo, uint64_t timestamp = 0);

  static bool getPaymentId(const transaction_t& transaction, hash_t& paymentId);
