...
struct EllipticCurveScalar {
  ...
  class crypto_ops {
    ...
    static bool generate_key_derivation(const PublicKey &, const SecretKey &, key_derivation_t &);
    friend bool generate_key_derivation(const PublicKey &, const SecretKey &, key_derivation_t &);
    static bool derive_public_key(const key_derivation_t &, size_t, const PublicKey &, PublicKey &);
    friend bool derive_public_key(const key_derivation_t &, size_t, const PublicKey &, PublicKey &);
    friend bool derive_public_key(const key_derivation_t &, size_t, const PublicKey &, const uint8_t*, size_t, PublicKey &);
    static bool derive_public_key(const key_derivation_t &, size_t, const PublicKey &, const uint8_t*, size_t, PublicKey &);
    //hack for pg
    static bool underive_public_key_and_get_scalar(const key_derivation_t &, std::size_t, const PublicKey &, PublicKey &, EllipticCurveScalar &);
    friend bool underive_public_key_and_get_scalar(const key_derivation_t &, std::size_t, const PublicKey &, PublicKey &, EllipticCurveScalar &);
    ...
    //
    static void derive_secret_key(const key_derivation_t &, size_t, const SecretKey &, SecretKey &);
    friend void derive_secret_key(const key_derivation_t &, size_t, const SecretKey &, SecretKey &);
    static void derive_secret_key(const key_derivation_t &, size_t, const SecretKey &, const uint8_t*, size_t, SecretKey &);
    friend void derive_secret_key(const key_derivation_t &, size_t, const SecretKey &, const uint8_t*, size_t, SecretKey &);
    static bool underive_public_key(const key_derivation_t &, size_t, const PublicKey &, PublicKey &);
    friend bool underive_public_key(const key_derivation_t &, size_t, const PublicKey &, PublicKey &);
    static bool underive_public_key(const key_derivation_t &, size_t, const PublicKey &, const uint8_t*, size_t, PublicKey &);
    friend bool underive_public_key(const key_derivation_t &, size_t, const PublicKey &, const uint8_t*, size_t, PublicKey &);
    static void generate_signature(const Hash &, const PublicKey &, const SecretKey &, signature_t &);
    friend void generate_signature(const Hash &, const PublicKey &, const SecretKey &, signature_t &);
    static bool check_signature(const Hash &, const PublicKey &, const signature_t &);
    friend bool check_signature(const Hash &, const PublicKey &, const signature_t &);
   ...
   */
  inline bool generate_key_derivation(const PublicKey &key1, const SecretKey &key2, key_derivation_t &derivation) {
   ...
   */
  inline void generate_signature(const Hash &prefix_hash, const PublicKey &pub, const SecretKey &sec, signature_t &sig) {
    crypto_ops::generate_signature(prefix_hash, pub, sec, sig);
  }
  inline bool check_signature(const Hash &prefix_hash, const PublicKey &pub, const signature_t &sig) {
