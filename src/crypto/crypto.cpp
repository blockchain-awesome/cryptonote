...
bool underive_public_key_and_get_scalar(const key_derivation_t &derivation, size_t output_index,
                                        const public_key_t &derived_key, public_key_t &base, elliptic_curve_scalar_t &hashed_derivation)
{
  ...
  derivation_to_scalar((const uint8_t *)&derivation, output_index, (uint8_t *)&hashed_derivation);
