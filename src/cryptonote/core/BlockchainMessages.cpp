...
NewBlockMessage::NewBlockMessage(const hash_t& hash) : blockHash(hash) {}

void NewBlockMessage::get(hash_t& hash) const {
  hash = blockHash;
}

NewAlternativeBlockMessage::NewAlternativeBlockMessage(const hash_t& hash) : blockHash(hash) {}

void NewAlternativeBlockMessage::get(hash_t& hash) const {
  hash = blockHash;
}

ChainSwitchMessage::ChainSwitchMessage(std::vector<hash_t>&& hashes) : blocksFromCommonRoot(std::move(hashes)) {}

ChainSwitchMessage::ChainSwitchMessage(const ChainSwitchMessage& other) : blocksFromCommonRoot(other.blocksFromCommonRoot) {}

void ChainSwitchMessage::get(std::vector<hash_t>& hashes) const {
...
bool BlockchainMessage::getNewBlockHash(hash_t& hash) const {
...
bool BlockchainMessage::getNewAlternativeBlockHash(hash_t& hash) const {
...
bool BlockchainMessage::getChainSwitch(std::vector<hash_t>& hashes) const {
