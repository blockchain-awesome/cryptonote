...
class ITransactionWriter
{
  public:
    ...
    virtual size_t addInput(const account_keys_t &senderKeys, const input_key_info_t &info, key_pair_t &ephKeys) = 0;
    ...
    // signing
    virtual void signInputKey(size_t input, const input_key_info_t &info, const key_pair_t &ephKeys) = 0;
