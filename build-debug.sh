...
lcov --capture --directory src --output-file temp.info
lcov --remove temp.info --output-file '/usr/include/*' './include/*' coverage.info
lcov --list coverage.info
genhtml coverage1.info --output-directory html || exit 1
