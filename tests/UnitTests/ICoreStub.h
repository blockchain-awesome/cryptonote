...
public:
  ...
  virtual bool handleIncomingTransaction(const cryptonote::transaction_t& tx, const crypto::hash_t& txHash, size_t blobSize, cryptonote::TxVerificationContext& tvc, bool keptByBlock) override;
