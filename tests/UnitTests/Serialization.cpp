...
//  tx.signatures.clear();
//  ASSERT_TRUE(serialization::dump_binary(tx, blob));
//  blob.append(std::string(sizeof(signature_t) / 2, 'x'));
//  ASSERT_FALSE(serialization::parse_binary(blob, tx1));
//
//  // blob contains one signature
//  blob.append(std::string(sizeof(signature_t) / 2, 'y'));
//  ASSERT_FALSE(serialization::parse_binary(blob, tx1));
//
...
//  blob.resize(blob.size() - sizeof(signature_t) / 2);
//  ASSERT_FALSE(serialization::parse_binary(blob, tx1));
//
//  // Blob contains too much data
//  blob.resize(blob.size() + sizeof(signature_t));
//  ASSERT_FALSE(serialization::parse_binary(blob, tx1));
//
