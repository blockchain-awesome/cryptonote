...
bool test_transaction_generation_and_ring_signature()
{
  ...
  hash_t pref_hash = BinaryArray::objectHash(*static_cast<transaction_prefix_t*>(&tx_rc1));
...
bool test_block_creation()
{
  ...
  block_t b;
  r = currency.constructMinerTx(90, math::medianValue(szs), 3553616528562147, 33094, 10000000, adr, b.baseTransaction, binary_array_t(), 11);
  return r;
}
